...
<div id="wrap">
 ...
 <div id="header1">
    ...
    <div id="header2">     
      <div id="head2"> 
        <marquee id="marquee">
         <h1 id="marqp"><strong>Kitabu Wassunnah Hotel</strong></h1>
       </marquee>
      </div>   
     ...
     <div id="header3">
          <div id="head3">
              ...
              <div class="mainlist">    <h3 class="mylist"><a href="dhaka.php">Zaranda</a></h3>        </div>
